...
import sadFaceImg from '../assets/images/sad.svg';
...

      {
        isClosed ?
          <div className="closed-room">
            <img src={sadFaceImg} alt="Sala encerrada" />
            <h2>Essa sala já foi encerrada</h2>
            <p>Para voltar para o início <Link to="/">clique aqui</Link>.</p>
          </div>
          :
          <main>
